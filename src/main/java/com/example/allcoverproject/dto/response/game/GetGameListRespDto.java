...
public class GetGameListRespDto extends CodeMessageRespDto {
    ...
    private GetGameListRespDto(List<Game> games, List<List<Scoreboard>> scoreboards) {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
        this.games = GameResp.getClubPageRespList(games, scoreboards);
    }

    public static ResponseEntity<GetGameListRespDto> success(List<Game> games, List<List<Scoreboard>> scoreboards) {
